...
assert(pending.includes(`/learn review`) && pending.includes(`/learn show <id>`), "pending should show next review/show actions");
...
assert(shown.includes(`next: /learn review`), "pending show should suggest UI review");
